...
function submit_to()
{
	...
	$.ajax({
		...
		success : function(JSONData,status){
			...
			alert("JSON.stringify(JSONData).split : "+JSON.stringify(JSONData).slice(1,21));
			

			tempImg="<p><img src=/images/board/"+JSON.stringify(JSONData).slice(1,21)+" width='500' heigth='250'/></p>";
			
			alert("tempImg = "+tempImg);
		}
	})
