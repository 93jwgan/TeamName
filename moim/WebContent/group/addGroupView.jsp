...
$(function(){
	...
	$("#ageLimitCheck").bind("click", function() {
		
		if( $("#ageLimitCheck").is(":checked") ){
			$("#ageLimitStart").attr("disabled",true);
			$("#ageLimitEnd").attr("disabled",true);
			
			$("#ageLimitStart").val("1918");
			$("#ageLimitEnd").val("2018");
		}
		else{
			$("#ageLimitStart").attr("disabled",false);
			$("#ageLimitEnd").attr("disabled",false);
		}
	});
...
<div class="control-group">
  ...
  <div class="controls">
    ...
    <input type="checkbox" id="ageLimitCheck"> 제한없음
  </div>
</div>
